locals {
  project_svc_tenancy_ocid_map = {
    ...
    "oc1" = "ocid1.tenancy.oc1..aaaaaaaaiw6ql6qiyfaed2ug3escrjar5azwwkf73efwmwpr4jryirourifq" //devopsproject
  }

  project_svc_cp_compartment_name = "project_service_control_plane_api"

  project_svc_tenancy_id = lookup(local.project_svc_tenancy_ocid_map, (var.environment == "prod" ? var.realm : var.environment), "not_defined")
